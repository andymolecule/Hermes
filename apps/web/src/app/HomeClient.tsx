...
function getDomainStyle(domain: string) {
  ...
  return (
    map[domain] || {
      bg: "#f8fafc",
      text: "var(--text-muted)",
      label: domain?.replace(/_/g, " ").toUpperCase() || "OTHER",
    }
  );
}
...
function getTableStatus(status: string, deadline?: string) {
  ...
  const s: Record<
    string,
    { dot: string; text: string; label: string; timeColor: string }
  > = {
    open: {
      dot: "#10b981",
...
export function HomeClient() {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* ═══ KPI STRIP ═══ */}
      <section
        className="rounded-2xl py-10 px-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-8"
      ...
      >
        ...
        >
          ...
          <div
            className="font-display font-bold mt-3 tabular-nums"
              ...
              >
                ...
                {(["table", "grid"] as const).map((v) => (
                  <button
                    ...
                    style={{
                      color:
                        view === v ? "var(--on-primary)" : "var(--text-muted)",
                    }}
                  >
          ...
          {query.isLoading ? (
            ...
            >
              ...
              <button
                type="button"
                onClick={() => query.refetch()}
                className="mt-4 px-6 py-2 text-sm font-sans font-bold"
                style={{
                  backgroundColor: "var(--text-primary)",
                  color: "var(--on-primary)",
                  borderRadius: "8px",
            ...
            <>
              <div className="overflow-hidden" style={{ borderRadius: "12px" }}>
                ...
                <div
                  ...
                  style={{
                    gridTemplateColumns:
                      "minmax(0, 1.1fr) minmax(0, 2.4fr) minmax(0, 0.8fr) minmax(0, 0.9fr) minmax(0, 1fr) minmax(0, 0.6fr) minmax(0, 0.8fr)",
                ...
                >
                  {[
                    ...
                    <div
                      key={col}
                      className={`flex items-center gap-1 font-mono font-medium uppercase ${!["Agent", "Bounty Title"].includes(col) ? "justify-center" : ""}`}
                      style={{
                        fontSize: "10px",
                        letterSpacing: "0.1em",
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 pr-4">
                          <div
                            className="font-sans font-semibold leading-snug truncate"
                            style={{
                              fontSize: "0.9375rem",
                              color: dead
                                ? "var(--text-muted)"
                          ...
                          <div
                            ...
                            style={{ color: "var(--text-muted)" }}
                          >
                            {ch.description?.slice(0, 90) || "No description."}
                          </div>
                        </div>
                        <div
                        ...
                        <div className="text-center">
                          <span
                            className="inline-block px-2.5 py-0.5 font-mono font-medium uppercase"
                            style={{
                              fontSize: "10px",
                              ...
                              backgroundColor: dead
                                ? "var(--surface-container-high)"
                                : dom.bg,
                              color: dead ? "var(--text-muted)" : dom.text,
                              borderRadius: "var(--radius-full)",
                            }}
                          >
                            {dom.label}
                        ...
                        <div
                          ...
                          style={{
                            color: st.timeColor,
                            fontWeight: st.label === "ENDING SOON" ? 600 : 400,
                          }}
                        >
                          {dead ? "--" : cd}
                        </div>
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() => setPage(pn)}
                          className="w-9 h-9 text-sm font-sans font-bold transition-colors"
                          style={{
                            backgroundColor:
                              page === pn
                                ? "var(--text-primary)"
                    ...
                    {totalPages > 5 && page < totalPages - 2 && (
                      <>
                        <span
                          className="px-1 font-sans font-bold"
                          style={{ color: "var(--text-muted)" }}
                        >
                          ...
                        </span>
                        <button
                          ...
                          className="w-9 h-9 text-sm font-sans font-bold"
                          style={{
                            color: "var(--text-secondary)",
                            borderRadius: "8px",
                          }}
