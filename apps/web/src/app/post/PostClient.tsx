...
function SectionHeader({ step, title, totalSteps = 6 }: { step: number; title: string; totalSteps?: number }) {
  return (
    <div className="form-section-header">
      ...
      <span className="form-section-meta">Step {step} of {totalSteps}</span>
    </div>
  );
}
  ...
  return (
    <div className="post-form">
      ...
      <div className="form-section">
        ...
        <div className="form-section-body">
          <div className="poster-step-intro">
            <p className="poster-step-intro-title">What are you paying, and when does it close?</p>
            <p className="poster-step-intro-copy">
              Set the reward pool that gets escrowed on-chain, choose how it&apos;s distributed, and define the operating window for this bounty.
            </p>
          </div>
          <div className="form-grid">
            {/* Prominent reward pool input */}
            <div className="span-full" style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <span style={{ fontSize: "0.7rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "#4A6B4D", fontFamily: "var(--font-mono)" }}>
                  Reward Pool
                </span>
                <span style={{ fontSize: "0.65rem", color: "var(--text-tertiary)", fontFamily: "var(--font-mono)" }}>
                  {CHALLENGE_LIMITS.rewardMinUsdc}–{CHALLENGE_LIMITS.rewardMaxUsdc} USDC
                </span>
              </div>
              <div style={{ display: "flex", alignItems: "baseline", gap: "0.5rem" }}>
                <input
                  ...
                  value={state.reward}
                  onChange={(e) => setState((s) => ({ ...s, reward: e.target.value }))}
                  style={{
                    fontSize: "2rem",
                    fontWeight: 700,
                ...
                />
                <span style={{ fontSize: "1.1rem", fontWeight: 700, color: "#4A6B4D", fontFamily: "var(--font-mono)", letterSpacing: "0.04em" }}>USDC</span>
              </div>
              <span style={{ fontSize: "0.72rem", color: "var(--text-tertiary)" }}>
                Escrowed on-chain when you publish. {PROTOCOL_FEE_PERCENT}% protocol fee applies.
              </span>
            </div>
      ...
      <div className="form-section">
        ...
        <div className="form-section-body">
          <div className="poster-step-intro">
            <p className="poster-step-intro-title">How will Agora judge submissions?</p>
            <p className="poster-step-intro-copy">
              This defines the official scoring rule that determines how submissions are ranked and who gets paid.
            </p>
          </div>
          <div className="form-grid">
            {state.type === "prediction" && (
