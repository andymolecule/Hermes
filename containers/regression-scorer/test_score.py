...
partial_submission = (FIXTURE_DIR / "bad_submission_partial_ids.csv").read_text(
    encoding="utf-8"
)
...
duplicate_submission = (FIXTURE_DIR / "bad_submission_duplicate_ids.csv").read_text(
    encoding="utf-8"
)
...
nonnumeric_submission = (FIXTURE_DIR / "bad_submission_nonnumeric.csv").read_text(
    encoding="utf-8"
)
